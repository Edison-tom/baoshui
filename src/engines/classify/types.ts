...
export interface ClassificationResult {
  ...
  incomeEntries: ClassifiedEntry[]; costEntries: ClassifiedEntry[]
  expenseEntries: ClassifiedEntry[]; transferEntries: ClassifiedEntry[]
  lowConfidenceEntries: ClassifiedEntry[]
  deemedSales: ClassifiedEntry[]; inputTransferOut: ClassifiedEntry[]
  dutyFree: ClassifiedEntry[]; crossPeriod: ClassifiedEntry[]
}
